...
cc1 = zeros(filter_params.M1, 1); tmp = fft(xx)./fft(pre);
cc1(filter_params.e1) = tmp(filter_params.e1); 
tmp = fft(RxSignal(161:192))./fft(preambles_only(161:192));
cc2 = zeros(filter_params.M1, 1);
cc2(filter_params.e1) = tmp(filter_params.e1);

channel_estimate = ifftshift(ifft(cc1));
