...
% output = X1(1:filter_params.N1-1,filter_params.e1)+ X2(1:filter_params.N1-1,filter_params.e1); 
output = X1(1:filter_params.N1-1,[3:12, 21:31])+ X2(1:filter_params.N1-1,[3:12, 21:31]); 
output = output(:);
scatterplot(output);
